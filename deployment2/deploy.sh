...
scp -i ~/.ssh/Tenet.pem -r deployment2/server-scripts/* "ec2-user@$SERVER_URL:/home/ec2-user/"
...
scp -i ~/.ssh/Tenet.pem bin/relay "ec2-user@$SERVER_URL:/home/ec2-user/relay"
