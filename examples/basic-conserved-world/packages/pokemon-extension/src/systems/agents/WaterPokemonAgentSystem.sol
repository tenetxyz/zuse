...
contract WaterPokemonAgentSystem is AgentType {
  ...
  function getInteractionSelectors() public override returns (InteractionSelector[] memory) {
    ...
    voxelInteractionSelectors[3] = InteractionSelector({
      interactionSelector: IWorld(_world()).pokemon_WaterPokemonAgen_infernoClashEventHandler.selector,
    ...
    voxelInteractionSelectors[6] = InteractionSelector({
      interactionSelector: IWorld(_world()).pokemon_WaterPokemonAgen_pyroBarrierEventHandler.selector,
    ...
    voxelInteractionSelectors[9] = InteractionSelector({
      interactionSelector: IWorld(_world()).pokemon_WaterPokemonAgen_tidalCrashEventHandler.selector,
    ...
    voxelInteractionSelectors[12] = InteractionSelector({
      interactionSelector: IWorld(_world()).pokemon_WaterPokemonAgen_mistVeilEventHandler.selector,
    ...
    voxelInteractionSelectors[15] = InteractionSelector({
      interactionSelector: IWorld(_world()).pokemon_WaterPokemonAgen_thornBurstEventHandler.selector,
    ...
    voxelInteractionSelectors[18] = InteractionSelector({
      interactionSelector: IWorld(_world()).pokemon_WaterPokemonAgen_verdantGuardEventHandler.selector,
