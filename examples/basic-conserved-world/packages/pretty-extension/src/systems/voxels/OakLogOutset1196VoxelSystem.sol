  ...
  function registerBody() public override {
    ...
    registerVoxelType(
      ...
      voxelSelectorsForVoxel(
        IWorld(world).pretty_OakLogOutset1196_enterWorld.selector,
        IWorld(world).pretty_OakLogOutset1196_exitWorld.selector,
        IWorld(world).pretty_OakLogOutset1196_variantSelector.selector,
        IWorld(world).pretty_OakLogOutset1196_activate.selector,
        IWorld(world).pretty_OakLogOutset1196_eventHandler.selector,
        IWorld(world).pretty_OakLogOutset1196_neighbourEventHandler.selector
      ),
