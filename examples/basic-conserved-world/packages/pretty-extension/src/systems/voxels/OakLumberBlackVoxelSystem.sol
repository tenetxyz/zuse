  ...
  function registerBody() public override {
    ...
    registerVoxelType(
      ...
      voxelSelectorsForVoxel(
        IWorld(world).pretty_C31E9_enterWorld.selector,
        IWorld(world).pretty_C31E9_exitWorld.selector,
        IWorld(world).pretty_C31E9_variantSelector.selector,
        IWorld(world).pretty_C31E9_activate.selector,
        IWorld(world).pretty_C31E9_eventHandler.selector,
        IWorld(world).pretty_C31E9_neighbourEventHandler.selector
      ),
