  ...
  function registerBody() public override {
    ...
    registerVoxelType(
      ...
      voxelSelectorsForVoxel(
        IWorld(world).pretty_C31D773_enterWorld.selector,
        IWorld(world).pretty_C31D773_exitWorld.selector,
        IWorld(world).pretty_C31D773_variantSelector.selector,
        IWorld(world).pretty_C31D773_activate.selector,
        IWorld(world).pretty_C31D773_eventHandler.selector,
        IWorld(world).pretty_C31D773_neighbourEventHandler.selector
      ),
