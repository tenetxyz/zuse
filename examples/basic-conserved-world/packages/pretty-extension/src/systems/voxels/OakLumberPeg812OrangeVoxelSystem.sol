  ...
  function registerBody() public override {
    ...
    registerVoxelType(
      ...
      voxelSelectorsForVoxel(
        IWorld(world).pretty_C31D812E4_enterWorld.selector,
        IWorld(world).pretty_C31D812E4_exitWorld.selector,
        IWorld(world).pretty_C31D812E4_variantSelector.selector,
        IWorld(world).pretty_C31D812E4_activate.selector,
        IWorld(world).pretty_C31D812E4_eventHandler.selector,
        IWorld(world).pretty_C31D812E4_neighbourEventHandler.selector
      ),
