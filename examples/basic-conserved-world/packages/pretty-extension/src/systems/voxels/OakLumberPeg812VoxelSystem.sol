  ...
  function registerBody() public override {
    ...
    registerVoxelType(
      ...
      voxelSelectorsForVoxel(
        IWorld(world).pretty_C31D812_enterWorld.selector,
        IWorld(world).pretty_C31D812_exitWorld.selector,
        IWorld(world).pretty_C31D812_variantSelector.selector,
        IWorld(world).pretty_C31D812_activate.selector,
        IWorld(world).pretty_C31D812_eventHandler.selector,
        IWorld(world).pretty_C31D812_neighbourEventHandler.selector
      ),
