  ...
  function registerBody() public override {
    ...
    registerVoxelType(
      ...
      voxelSelectorsForVoxel(
        IWorld(world).pretty_C31D199_enterWorld.selector,
        IWorld(world).pretty_C31D199_exitWorld.selector,
        IWorld(world).pretty_C31D199_variantSelector.selector,
        IWorld(world).pretty_C31D199_activate.selector,
        IWorld(world).pretty_C31D199_eventHandler.selector,
        IWorld(world).pretty_C31D199_neighbourEventHandler.selector
      ),
