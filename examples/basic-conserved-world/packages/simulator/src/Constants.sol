...
// Signatures
string constant SIM_INIT_ENTITY_SIG = "initEntity((uint32,bytes32),uint256,uint256,(int32,int32,int32),uint256)";
string constant SIM_ON_BUILD_SIG = "onBuild((uint32,bytes32),(int32,int32,int32),uint256)";
