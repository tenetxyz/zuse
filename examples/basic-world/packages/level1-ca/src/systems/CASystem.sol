...
import { AirVoxelID, GrassVoxelID, DirtVoxelID, BedrockVoxelID, RockVoxelID } from "@tenet-level1-ca/src/Constants.sol";
...
contract CASystem is CA {
  ...
  function registerCA() public override {
    ...
    caVoxelTypes[4] = RockVoxelID;

    safeCall(
      getRegistryAddress(),
      abi.encodeWithSignature(REGISTER_CA_SIG, "Level 1 CA", "Has grass, dirt, bedrock, rock", caVoxelTypes),
      "registerCA"
    );
  }
