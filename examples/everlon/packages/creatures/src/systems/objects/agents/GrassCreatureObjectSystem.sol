...
contract GrassCreatureObjectSystem is AgentType {
  function registerObject() public {
    ...
    registerObjectType(
      ...
      IWorld(world).creatures_GrassCreatureObj_exitWorld.selector,
      IWorld(world).creatures_GrassCreatureObj_eventHandler.selector,
      IWorld(world).creatures_GrassCreatureObj_neighbourEventHandler.selector,
      "Grass Creature",
      ""
    );
  }
