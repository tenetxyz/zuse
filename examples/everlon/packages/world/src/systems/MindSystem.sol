...
import { Mind, MindTableId } from "@tenet-world/src/codegen/tables/Mind.sol";

contract MindSystem is System {
  function setMindSelector(bytes32 objectEntityId, bytes4 mindSelector) public {
    ...
    Mind.set(objectEntityId, mindSelector);
  }
}
