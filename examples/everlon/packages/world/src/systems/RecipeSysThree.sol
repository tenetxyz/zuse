...
contract RecipeSysThree is System {
  function initRecipesThree() public {
    ...
    inputObjectTypeIds[1] = OakLogObjectID; // Using OakLogObjectID as a placeholder for "log"
    inputObjectTypeAmounts = new uint8[](2);
    inputObjectTypeAmounts[0] = 8; // 8 Stone
    inputObjectTypeAmounts[1] = 4; // 4 Log

    outputObjectTypeIds = new bytes32[](1);
    outputObjectTypeIds[0] = StoneAxeObjectID; // TODO: Define StoneAxeObjectID
    outputObjectTypeAmounts = new uint8[](1);
    outputObjectTypeAmounts[0] = 1; // 1 Stone Axe

    outputObjectProperties = new ObjectProperties[](1);
    outputOutputProperties.mass = STONE_AXE_MASS; // TODO: Define STONE_AXE_MASS
    outputObjectProperties[0] = outputOutputProperties;
    ...
    outputObjectTypeIds = new bytes32[](1);
    outputObjectTypeIds[0] = StonePickObjectID; // TODO: Define StonePickObjectID
    outputObjectTypeAmounts = new uint8[](1);
    outputObjectTypeAmounts[0] = 1; // 1 Stone Pick

    outputObjectProperties = new ObjectProperties[](1);
    outputOutputProperties.mass = STONE_PICK_MASS; // TODO: Define STONE_PICK_MASS
    outputObjectProperties[0] = outputOutputProperties;
    ...
    inputObjectTypeIds = new bytes32[](2);
    inputObjectTypeIds[0] = StoneObjectID; // Defined earlier
    inputObjectTypeIds[1] = OakLogObjectID; // Using OakLogObjectID for "log"
    inputObjectTypeAmounts = new uint8[](2);
    inputObjectTypeAmounts[0] = 4; // 4 Stone
    inputObjectTypeAmounts[1] = 2; // 2 Log

    outputObjectTypeIds = new bytes32[](1);
    outputObjectTypeIds[0] = StoneWhackerObjectID; // TODO: Define StoneWhackerObjectID
    outputObjectTypeAmounts = new uint8[](1);
    outputObjectTypeAmounts[0] = 1; // 1 Stone Whacker

    outputObjectProperties = new ObjectProperties[](1);
    outputOutputProperties.mass = STONE_WHACKER_MASS; // TODO: Define STONE_WHACKER_MASS
    outputObjectProperties[0] = outputOutputProperties;
    ...
    outputObjectTypeAmounts = new uint8[](1);
    outputObjectTypeAmounts[0] = 4; // 4 Stone Brick

    outputObjectProperties = new ObjectProperties[](1);
    outputOutputProperties.mass = STONE_BRICK_MASS; // TODO: Define STONE_BRICK_MASS
    outputObjectProperties[0] = outputOutputProperties;
    ...
    outputObjectTypeAmounts = new uint8[](1);
    outputObjectTypeAmounts[0] = 4; // 4 Stone Carved

    outputObjectProperties = new ObjectProperties[](1);
    outputOutputProperties.mass = STONE_CARVED_MASS; // TODO: Define STONE_CARVED_MASS
    outputObjectProperties[0] = outputOutputProperties;
    ...
    outputObjectTypeAmounts = new uint8[](1);
    outputObjectTypeAmounts[0] = 4; // 4 Polished Stone

    outputObjectProperties = new ObjectProperties[](1);
    outputOutputProperties.mass = POLISHED_STONE_MASS; // TODO: Define POLISHED_STONE_MASS
    outputObjectProperties[0] = outputOutputProperties;
    ...
    outputObjectTypeAmounts = new uint8[](1);
    outputObjectTypeAmounts[0] = 4; // 4 Stone Shingles

    outputObjectProperties = new ObjectProperties[](1);
    outputOutputProperties.mass = STONE_SHINGLES_MASS; // TODO: Define STONE_SHINGLES_MASS
    outputObjectProperties[0] = outputOutputProperties;
