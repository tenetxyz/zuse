...
import { REGISTRY_ADDRESS, NUM_BLOCK_STACKABLE, ChestObjectID, CHEST_MASS } from "@tenet-world/src/Constants.sol";

contract ChestObjectSystem is ObjectType {
  function registerObject() public {
    address world = _world();
    IObjectRegistrySystem(REGISTRY_ADDRESS).registerObjectType(
      ChestObjectID,
      world,
      IWorld(world).world_ChestObjectSyste_enterWorld.selector,
  ...
  function enterWorld(
    ...
    objectProperties.mass = CHEST_MASS;
