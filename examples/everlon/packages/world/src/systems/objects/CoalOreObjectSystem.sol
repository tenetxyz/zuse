...
import { REGISTRY_ADDRESS, NUM_BLOCK_STACKABLE, CoalOreObjectID, COAL_ORE_MASS } from "@tenet-world/src/Constants.sol";

contract CoalOreObjectSystem is ObjectType {
  function registerObject() public {
    address world = _world();
    IObjectRegistrySystem(REGISTRY_ADDRESS).registerObjectType(
      CoalOreObjectID,
      world,
      IWorld(world).world_CoalOreObjectSys_enterWorld.selector,
      IWorld(world).world_CoalOreObjectSys_exitWorld.selector,
  ...
  function enterWorld(
    ...
    objectProperties.mass = COAL_ORE_MASS;
