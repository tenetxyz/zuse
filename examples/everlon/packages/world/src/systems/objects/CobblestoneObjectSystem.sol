...
import { REGISTRY_ADDRESS, CobblestoneObjectID, SIMPLE_BLOCK_MASS } from "@tenet-world/src/Constants.sol";
...
contract CobblestoneObjectSystem is ObjectType {
  function registerObject() public {
    ...
    IObjectRegistrySystem(REGISTRY_ADDRESS).registerObjectType(
      CobblestoneObjectID,
      world,
      IWorld(world).world_CobblestoneObjec_enterWorld.selector,
