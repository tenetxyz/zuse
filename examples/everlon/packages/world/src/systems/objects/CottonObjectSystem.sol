...
import { REGISTRY_ADDRESS, NUM_BLOCK_STACKABLE, CottonObjectID, COTTON_MASS } from "@tenet-world/src/Constants.sol";
...
contract CottonObjectSystem is ObjectType {
  function registerObject() public {
    ...
    IObjectRegistrySystem(REGISTRY_ADDRESS).registerObjectType(
      CottonObjectID,
      world,
      IWorld(world).world_CottonObjectSyst_enterWorld.selector,
      IWorld(world).world_CottonObjectSyst_exitWorld.selector,
