...
import { REGISTRY_ADDRESS, DiamondOreObjectID, SIMPLE_BLOCK_MASS } from "@tenet-world/src/Constants.sol";
...
contract DiamondOreObjectSystem is ObjectType {
  function registerObject() public {
    ...
    IObjectRegistrySystem(REGISTRY_ADDRESS).registerObjectType(
      DiamondOreObjectID,
      world,
      IWorld(world).world_DiamondOreObject_enterWorld.selector,
