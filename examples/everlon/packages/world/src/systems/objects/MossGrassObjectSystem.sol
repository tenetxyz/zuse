...
import { REGISTRY_ADDRESS, MossGrassObjectID, SIMPLE_LIGHT_BLOCK_MASS } from "@tenet-world/src/Constants.sol";
...
contract MossGrassObjectSystem is ObjectType {
  function registerObject() public {
    ...
    IObjectRegistrySystem(REGISTRY_ADDRESS).registerObjectType(
      MossGrassObjectID,
      world,
      IWorld(world).world_MossGrassObjectS_enterWorld.selector,
