...
import { REGISTRY_ADDRESS, NUM_BLOCK_STACKABLE, RubberLeafObjectID, RUBBER_LEAF_MASS } from "@tenet-world/src/Constants.sol";
...
contract RubberLeafObjectSystem is ObjectType {
  ...
  function enterWorld(
    ...
    objectProperties.mass = RUBBER_LEAF_MASS;
