...
import { REGISTRY_ADDRESS, NUM_BLOCK_STACKABLE, SunstoneObjectID, SUNSTONE_MASS } from "@tenet-world/src/Constants.sol";
...
contract SunstoneObjectSystem is ObjectType {
  function registerObject() public {
    ...
    IObjectRegistrySystem(REGISTRY_ADDRESS).registerObjectType(
      SunstoneObjectID,
      world,
      IWorld(world).world_SunstoneObjectSy_enterWorld.selector,
      IWorld(world).world_SunstoneObjectSy_exitWorld.selector,
      IWorld(world).world_SunstoneObjectSy_eventHandler.selector,
