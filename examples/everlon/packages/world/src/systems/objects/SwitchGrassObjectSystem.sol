...
import { REGISTRY_ADDRESS, NUM_BLOCK_STACKABLE, SwitchGrassObjectID, SWITCH_GRASS_MASS } from "@tenet-world/src/Constants.sol";
...
contract SwitchGrassObjectSystem is ObjectType {
  function registerObject() public {
    ...
    IObjectRegistrySystem(REGISTRY_ADDRESS).registerObjectType(
      SwitchGrassObjectID,
      world,
      IWorld(world).world_SwitchGrassObjec_enterWorld.selector,
      IWorld(world).world_SwitchGrassObjec_exitWorld.selector,
