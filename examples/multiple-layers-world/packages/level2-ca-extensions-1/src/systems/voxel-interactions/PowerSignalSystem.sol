...
import { PowerSignal, PowerSignalData, PowerWire, PowerWireData, InvertedSignalData, InvertedSignal, SignalSource, Generator } from "@tenet-level2-ca-extensions-1/src/codegen/Tables.sol";
import { BlockDirection } from "@tenet-utils/src/Types.sol";
import { getOppositeDirection } from "@tenet-utils/src/VoxelCoordUtils.sol";
import { entityIsPowerSignal, entityIsSignalSource, entityIsInvertedSignal, entityIsGenerator } from "@tenet-level2-ca-extensions-1/src/InteractionUtils.sol";
...
contract PowerSignalSystem is SingleVoxelInteraction {
  ...
  function neighbourEventHandlerPowerSignal(
    address callerAddress,
