...
import { PowerWire, PowerWireData, Generator, GeneratorData, StorageData, Storage, Consumer, ConsumerData } from "@tenet-level2-ca-extensions-1/src/codegen/Tables.sol";
import { BlockDirection } from "@tenet-utils/src/Types.sol";
import { entityIsPowerWire, entityIsGenerator, entityIsStorage, entityIsConsumer } from "@tenet-level2-ca-extensions-1/src/InteractionUtils.sol";
...
contract PowerWireSystem is SingleVoxelInteraction {
  ...
  function neighbourEventHandlerPowerWire(
    address callerAddress,
