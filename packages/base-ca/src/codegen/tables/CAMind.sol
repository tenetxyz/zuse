...
library CAMind {
  ...
  function set(bytes32 caEntity, bytes32 voxelTypeId, bytes4 mindSelector, bool hasValue) internal {
    bytes memory _data = encode(voxelTypeId, mindSelector, hasValue);
  ...
  function set(IStore _store, bytes32 caEntity, bytes32 voxelTypeId, bytes4 mindSelector, bool hasValue) internal {
    bytes memory _data = encode(voxelTypeId, mindSelector, hasValue);
  ...
  function set(bytes32 caEntity, CAMindData memory _table) internal {
    set(caEntity, _table.voxelTypeId, _table.mindSelector, _table.hasValue);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, bytes32 caEntity, CAMindData memory _table) internal {
    set(_store, caEntity, _table.voxelTypeId, _table.mindSelector, _table.hasValue);
  }
  ...
  function encode(bytes32 voxelTypeId, bytes4 mindSelector, bool hasValue) internal pure returns (bytes memory) {
    return abi.encodePacked(voxelTypeId, mindSelector, hasValue);
  }
