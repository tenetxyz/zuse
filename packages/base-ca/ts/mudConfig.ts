...
export enum TenetMudConfigType {
  Layer,
  World,
}
...
>(type: TenetMudConfigType, config: MUDUserConfig<T, EnumNames, StaticUserTypes>): ExpandMUDUserConfig<T> {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  if (type === TenetMudConfigType.Layer) {
    // add layer Tables
