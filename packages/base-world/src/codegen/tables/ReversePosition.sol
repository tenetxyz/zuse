...
library ReversePosition {
  ...
  /** Get scale */
  function getScale(int32 x, int32 y, int32 z) internal view returns (uint32 scale) {
  ...
  function getScale(IStore _store, int32 x, int32 y, int32 z) internal view returns (uint32 scale) {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(int256(x)));
    _keyTuple[1] = bytes32(uint256(int256(y)));
    _keyTuple[2] = bytes32(uint256(int256(z)));
  ...
  /** Set scale */
  function setScale(int32 x, int32 y, int32 z, uint32 scale) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(int256(x)));
    _keyTuple[1] = bytes32(uint256(int256(y)));
    _keyTuple[2] = bytes32(uint256(int256(z)));
  ...
  function setScale(IStore _store, int32 x, int32 y, int32 z, uint32 scale) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(int256(x)));
    _keyTuple[1] = bytes32(uint256(int256(y)));
    _keyTuple[2] = bytes32(uint256(int256(z)));
  ...
  /** Get the full data */
  function get(int32 x, int32 y, int32 z) internal view returns (ReversePositionData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(int256(x)));
    _keyTuple[1] = bytes32(uint256(int256(y)));
    _keyTuple[2] = bytes32(uint256(int256(z)));
  ...
  function get(IStore _store, int32 x, int32 y, int32 z) internal view returns (ReversePositionData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(int256(x)));
    _keyTuple[1] = bytes32(uint256(int256(y)));
    _keyTuple[2] = bytes32(uint256(int256(z)));
  ...
  function set(int32 x, int32 y, int32 z, uint32 scale, bytes32 entity, bool hasValue) internal {
    bytes memory _data = encode(scale, entity, hasValue);
  ...
  function set(int32 x, int32 y, int32 z, ReversePositionData memory _table) internal {
    set(x, y, z, _table.scale, _table.entity, _table.hasValue);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, int32 x, int32 y, int32 z, ReversePositionData memory _table) internal {
    set(_store, x, y, z, _table.scale, _table.entity, _table.hasValue);
  }
  ...
  function decode(bytes memory _blob) internal pure returns (ReversePositionData memory _table) {
    ...
    _table.entity = (Bytes.slice32(_blob, 4));

    _table.hasValue = (_toBool(uint8(Bytes.slice1(_blob, 36))));
  }

  /** Tightly pack full data using this table's schema */
  function encode(uint32 scale, bytes32 entity, bool hasValue) internal pure returns (bytes memory) {
    return abi.encodePacked(scale, entity, hasValue);
  }
