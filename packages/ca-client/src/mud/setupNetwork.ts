...
export async function setupNetwork() {
  ...
  const encodedBodySelectorsType = "(bytes4,bytes4,bytes4,bytes4,bytes4,(bytes4,string,string)[])";
  const encodedBodySelectorBytes =
    "";
  ...
  const decodedData = abi.decode([encodedBodySelectorsType], encodedBodySelectorBytes)[0];
