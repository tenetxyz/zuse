...
export const Textures = {
  ...
  Tile1: getNftStorageLink("bafkreidtehpqibhtrtxrmqwq7j6sg77ed5ie74gvnwc43a7w3ni6x5rumq"),
  Tile3: getNftStorageLink("bafkreieyverjnmklxj6u4lsudyjfry3ezano7xjvvx454d6xurxkw3w7cq"),
  Tile4: getNftStorageLink("bafkreia5o4wtc2cygbmywkcglfnzmzmzfpn6g2mdljqd3bjp7k5tkgspoi"),
  Tile5: getNftStorageLink("bafkreifw7lb4m42jw4wtkjy3zgwfr44uqkwg7uranqazei5knpkzbkexqa"),
};
...
export const UVWraps = {
  ...
  Tile1: getNftStorageLink("bafkreibakdlkrzelxxf6mo4m6qbjzhucna6aph7cf5azqntprtmyqsntki"),
  Tile3: getNftStorageLink("bafkreifu4usebe7nqjpezcrzgjqsiabvuxsffrjszxzzsvuwawtbrhw6ia"),
  Tile4: getNftStorageLink("bafkreieypgjex23vxc5qnnbju2pjrabp6fqezaiki2icukssvpyz2ryrny"),
  Tile5: getNftStorageLink("bafkreia52odexmenv7pcj7sm54nuu3ifylaijdckdkv7k3yxph4b6khnii"),
};
