...
contract MineSystem is System {
  ...
  function mine(VoxelCoord memory coord, bytes32 voxelType, bytes16 voxelVariantNamespace, bytes32 voxelVariantId) public returns (bytes32) {
    ...
    if (entitiesAtPosition.length == 0) {
      ...
      VoxelType.set(voxelToMine, namespace, voxelType, voxelVariantNamespace, voxelVariantId);
    } else {
      ...
      require(voxelTypeData.voxelType != voxelType
