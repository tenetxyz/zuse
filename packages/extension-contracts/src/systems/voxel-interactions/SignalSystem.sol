...
import { Signal, SignalData, InvertedSignalData, InvertedSignal, SignalSource, Generator } from "@tenet-extension-contracts/src/codegen/Tables.sol";
import { BlockDirection } from "@tenet-contracts/src/Types.sol";
import { getOppositeDirection } from "@tenet-contracts/src/Utils.sol";
import { registerExtension, entityIsSignal, entityIsSignalSource, entityIsInvertedSignal, entityIsGenerator } from "../../Utils.sol";
...
contract SignalSystem is SingleVoxelInteraction {
  ...
  function runSingleInteraction(
    ...
    if (signalData.isActive) {
      ...
      if (compareIsActiveGenerator || compareIsSignalSource || compareIsActiveSignal || compareIsActiveInvertedSignal) {
