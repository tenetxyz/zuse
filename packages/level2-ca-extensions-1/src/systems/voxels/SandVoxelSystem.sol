...
contract SandVoxelSystem is VoxelType {
  function registerVoxel() public override {
    ...
    BodyVariantsRegistryData memory sandVariant;
    ...
    registerBodyVariant(REGISTRY_ADDRESS, SandVoxelVariantID, sandVariant);

    bytes32[] memory sandChildBodyTypes = BodyTypeRegistry.getChildBodyTypeIds(
    ...
    registerCABodyType(CA_ADDRESS, SandVoxelID);
  }
