...
import { SignalSource } from "@tenet-level2-ca/src/codegen/tables/SignalSource.sol";
import { Powered } from "@tenet-level2-ca/src/codegen/tables/Powered.sol";
import { InvertedSignal } from "@tenet-level2-ca/src/codegen/tables/InvertedSignal.sol";
import { Temperature } from "@tenet-level2-ca/src/codegen/tables/Temperature.sol";
import { Generator } from "@tenet-level2-ca/src/codegen/tables/Generator.sol";
import { PowerWire } from "@tenet-level2-ca/src/codegen/tables/PowerWire.sol";
import { Storage } from "@tenet-level2-ca/src/codegen/tables/Storage.sol";
import { Consumer } from "@tenet-level2-ca/src/codegen/tables/Consumer.sol";
import { PowerSignal } from "@tenet-level2-ca/src/codegen/tables/PowerSignal.sol";
