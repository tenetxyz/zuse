...
import { REGISTRY_ADDRESS, WireVoxelID, WireOffVoxelVariantID, WireOnVoxelVariantID, WireOnTexture, WireOffTexture, WireOnUVWrap, WireOffUVWrap } from "@level2-ca/src/Constants.sol";
