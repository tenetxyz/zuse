...
string constant REGISTER_VOXEL_TYPE_SIG = "registerVoxelType(string,bytes32,bytes32,bytes32[],bytes32[],bytes32,(bytes4,bytes4,bytes4,bytes4,(bytes4,string,string)[]))";
