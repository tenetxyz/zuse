...
string constant REGISTER_VOXEL_TYPE_SIG = "registerVoxelType(string,bytes32,bytes32,bytes32[],bytes32[],bytes32,(bytes4,bytes4,bytes4,bytes4,bytes4,(bytes4,string,string)[]),bytes,uint256)";
...
string constant REGISTER_CREATION_SIG = "registerCreation(string,string,(bytes32,bytes32,bool)[],(int32,int32,int32)[],(bytes32,(int32,int32,int32),(int32,int32,int32)[])[])";
